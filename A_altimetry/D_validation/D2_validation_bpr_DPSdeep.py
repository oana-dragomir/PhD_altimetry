...
# temp dir
griddir = localdir + 'temporary/3_grid_dot/'
bprdir = localdir + 'temporary/BPRs/DPsouth_deep/'
# -----------------------------------------------------------------------------
# 1. Tide-gauge data

# Drake Passage South DEEP
# 2009-11-08 to 2013-12-31
filename = 'dpsd_all.txt'
...
# --------------------------------------------------------
# convert from day of the year to month
...
# average the predicted tide and bottom pressure monthly
...
# -----------------------------------------------------------------------------
# overlap period
#2009-12 to 2013-12 (discard first month because it is not fully sampled)
time_start = '2009-12-01'
time_end = '2013-12-01'
...
m.scatter(lon_dpsd, lat_dpsd, marker='x', c='k',
