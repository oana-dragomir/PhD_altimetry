...
# lat_step = list(set(wind_lat[1:] - wind_lat[:-1]))
# lon_step = list(set(wind_lon[1:] - wind_lon[:-1]))

# edges_lat = (wind_lat - lat_step).append(wind_lat[-1] + wind_lat)


# statistic = 'mean'
# sic_bin = bin2d(ice_lon, ice_lat, ice_sic, 
#           		statistic=statistic,
#             	bins=[edges_wlon, edges_wlat]).statistic
